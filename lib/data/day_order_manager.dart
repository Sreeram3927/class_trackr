...
class DayOrderManager {
  ...
  static getDayOrder(DateTime date) {
    String val = DateFormat('dd/MM').format(date);
    if (DayOrderDate.dayOrder_1.contains(val)) {return DayOrder.ttData['dO1'];} 
    else if (DayOrderDate.dayOrder_2.contains(val)) {return DayOrder.ttData['dO2'];} 
    else if (DayOrderDate.dayOrder_3.contains(val)) {return DayOrder.ttData['dO3'];} 
    else if (DayOrderDate.dayOrder_4.contains(val)) {return DayOrder.ttData['dO4'];} 
    else if (DayOrderDate.dayOrder_5.contains(val)) {return DayOrder.ttData['dO5'];}
